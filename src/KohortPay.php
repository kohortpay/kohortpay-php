...
/**
 * KohortPay - kohortPay: The Kohort API is organized around [REST](https://). Our API has predictable resource-oriented URLs, accepts application/json or [form-encoded](https://) request bodies, returns [JSON-encoded](https://) responses, and uses standard HTTP response codes, authentication, and verbs.
 * 
 * 
...
class KohortPay
{
	 ...
	 */
	public static function builder(): KohortPayBuilder
	{
		return new KohortPayBuilder();
	}
